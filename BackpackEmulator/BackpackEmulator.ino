...
void handleRoot() {
    ...
    html += "<div><label>Binding UID (HEX):</label><input type='text' name='uid' value='" + String(uid_buf) + "'></div>";
    ...
    html += "<div><label>L-Band:</label><select name='l_grid'><option value='0' " + String(config.l_grid==0?"selected":"") + ">Grid 1</option><option value='1' " + String(config.l_grid==1?"selected":"") + ">Grid 2 (X)</option></select></div>";
    html += "<br><input type='submit' class='btn' value='Save'></form><hr><a href='/bind' class='btn btn-sec'>Bind VRX</a></body></html>";
